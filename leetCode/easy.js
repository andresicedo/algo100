...
//     //identify the associated pairs in an obj literal
//     let closedBrackets = {
//         ")": "(",
//         "}": "{",
//         "]": "["
...
//         const val = str[i];
//         //if val is an open bracket,push to array
//         if (val === "(" || val === "[" || val === "{") {
//             openBrackets.push(val);
//             //if a closing bracket matches with keys of obj
//             //pop open bracket from the arr 
//             //If there is a mismatch, return false.
//         } else if (openBrackets[openBrackets.length - 1] === closedBrackets[val]) {
//             openBrackets.pop();
//         } else return false;
//     }
//     //should have no remaining values in open bracket array if string is balanced
